...
def VisualizeData(CENTERS, CUBdat, CUBdatESP, xx, yy, zz):
    ...
    def rebuild_surface():
        ...
        try:
            ...
            if scalar_bar is not None:
                ...
                scalar_bar.GetTitleTextProperty().SetFontSize(24)
    ...
    def save_current_view():
        ...
        try:
            ...
            messagebox.showinfo("Saved", "Image saved to:\n{}".format(file_path), parent=control_window)
        except Exception as exc:
            messagebox.showerror("Save failed", str(exc), parent=control_window)
    ...
    action_row.grid(row=6, column=0, columnspan=3, sticky="we", pady=(8, 0))
    tk.Button(action_row, text="Save as...", command=save_current_view, width=12).pack(side="left")
    tk.Button(action_row, text="Close viewer", command=close_both, width=12).pack(side="left", padx=(8, 0))
